...
function $76d06fcdc9bff1f5$export$77714ac6976d0316(args) {
    const opts = (0, $83fd64f7195557f0$export$2e2bcd8739ae039)(args, {
        default: {
            ...
            "builder": (0, $0bb303b6376d48ba$exports.getInput)("builder") || "default",
            "help": false
        },
        string: [
            "cache-map",
...
function $ac602fd4d31c6b69$var$hookChildProcess(cp, parsed) {
    ...
    cp.emit = function(name, arg1) {
        ...
        if (name === "exit") {
            const err = $ac602fd4d31c6b69$var$verifyENOENT(arg1, parsed);
...
async function $bd1d73aff0732146$var$injectCache(cacheSource, cacheOptions, scratchDir, builder) {
...
async function $bd1d73aff0732146$export$38c65e9f06d3d433(opts) {
    ...
    for (const [cacheSource, cacheOptions] of Object.entries(cacheMap))await $bd1d73aff0732146$var$injectCache(cacheSource, cacheOptions, scratchDir, builder);
}
...
async function $8d40300f3635b768$var$extractCache(cacheSource, cacheOptions, scratchDir, builder) {
    // Prepare Timestamp for Layer Cache Busting
    const date = new Date().toISOString();
    await (0, $evV72$fspromises).mkdir(scratchDir, {
        recursive: true
...
async function $8d40300f3635b768$export$bd3cfa0c41fc7012(opts) {
    ...
    for (const [cacheSource, cacheOptions] of Object.entries(cacheMap))await $8d40300f3635b768$var$extractCache(cacheSource, cacheOptions, scratchDir, builder);
}
